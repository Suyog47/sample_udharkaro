...
class TakenAmountDetails extends StatefulWidget {

  @override
  _TakenAmountDetailsState createState() => _TakenAmountDetailsState();
}

class _TakenAmountDetailsState extends State<TakenAmountDetails> {
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        height10,
                        height5,
                        Center(child: T16Light(txt: LanguageController().getText(receiptTakenHeaderTxt))),
                        height5,
                        Center(
                          child: H3Light(
                    ...
                    child: SingleChildScrollView(
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            height5,
                            AmountDetailsText(txt: LanguageController().getText(receiptReceivedTxt),),
                            Row(
                              children: [
                                const T18Dark(txt: "₹"),
                                H3Dark(
